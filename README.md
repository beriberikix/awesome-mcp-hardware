...
- [eda-agent](https://github.com/salitronic/eda-agent) - Open-source MCP server that automates Altium Designer over a local bridge, with 290+ tools for schematic, PCB, library and project tasks and an autonomous design-plan executor.
